...
class ThemeProvider extends InheritedWidget {
  ...
  TextStyle get button => subhead1Semi;
  ...
  ThemeData themeData(ThemeData theme) {
    return ThemeData(
      ...
      inputDecorationTheme: InputDecorationTheme(
        isDense: false,
        focusedBorder: UnderlineInputBorder(borderSide: BorderSide(color: MkColors.primaryAccent, width: 1.0)),
        enabledBorder: UnderlineInputBorder(borderSide: BorderSide(color: kBorderSideColor, width: 2.0)),
